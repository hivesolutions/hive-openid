<div id="header">
    <div id="header-wrapper">
        ...
        ${else /}
            ...
            <div class="header-tools">
                <p class="user-signed-status light-black">
                    <span class="link">openid.hive.pt/<span class="user-signed-status-name">${out_none value=session_pt_hive_cronus_plugins_hive_openid_user_information.username /}</span></span>
                </p>
                <p class="header-links dark-blue">
                    <a class="underline-link" href="${out_none value=base_path /}index">home</a> |
                    <a class="underline-link" href="${out_none value=base_path /}users/${out_none value=session_pt_hive_cronus_plugins_hive_openid_user_information.username /}">your account</a> |
